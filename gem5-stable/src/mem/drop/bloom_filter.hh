...
public:
   ...
   {
      SERIALIZE(minimum_size)
      SERIALIZE(maximum_size)
      SERIALIZE(minimum_number_of_hashes)
      SERIALIZE(maximum_number_of_hashes)
      SERIALIZE(projected_element_count)
      SERIALIZE(false_positive_probability)
      SERIALIZE(random_seed)
      SERIALIZE(optimal_parameters)
   }

   void unserialize(std::istream &is)
   {
      UNSERIALIZE(minimum_size)
      UNSERIALIZE(maximum_size)
      UNSERIALIZE(minimum_number_of_hashes)
      UNSERIALIZE(maximum_number_of_hashes)
      UNSERIALIZE(projected_element_count)
      UNSERIALIZE(false_positive_probability)
      UNSERIALIZE(random_seed)
      UNSERIALIZE(optimal_parameters)
   }
};
...
protected:
  ...
  public:
    void serialize(std::ostream &os)
    {
      SERIALIZE(salt_count_)
      SERIALIZE(table_size_)
      SERIALIZE(raw_table_size_)
      SERIALIZE(projected_element_count_)
      SERIALIZE(inserted_element_count_)
    ...
    void unserialize(std::istream &is)
    {
      UNSERIALIZE(salt_count_)
      UNSERIALIZE(table_size_)
      UNSERIALIZE(raw_table_size_)
      UNSERIALIZE(projected_element_count_)
      UNSERIALIZE(inserted_element_count_)
      UNSERIALIZE(random_seed_)
