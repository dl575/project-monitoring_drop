...
open my $ex, "-|", "gem5.debug --debug-flags=SlackTimer,Fifo $gem5/configs/example/dual_core.py -c $gem5/tests/monitoring/wcet_program.arm; ".
                   "gem5.debug --debug-flags=SlackTimer,Fifo $gem5/configs/example/dual_core.py -c $gem5/tests/monitoring/wcet_program_timer.arm"
