...
print <<END;
---------------------------------------------------------
Make sure you set your monitor in the monitor.py
...
open my $ex, "-|", "gem5.debug --debug-flags=SlackTimer,Fifo $gem5/configs/example/flex_core_hardwcet.py -c $gem5/tests/monitoring/wcet_program.arm --caches; ".
                   "gem5.debug --debug-flags=SlackTimer,Fifo $gem5/configs/example/flex_core_hardwcet.py -c $gem5/tests/monitoring/wcet_program_timer.arm --caches"
