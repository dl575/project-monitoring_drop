...
def run(config, n_jobs):
  ...
  for prod in itertools.product(config['cpu_type'], config['core_frequency'], config['monitor_frequency'], 
    ...
    config_args += ' --checkpoint-restore=1 --checkpoint-dir=/ufs/cluster/dlo/run/drop_m5out/20141228-125914/atomic/core_2.45GHz/mon_2.45GHz/hb/1kB/%s/overhead_99.0000' % (prod[4])
