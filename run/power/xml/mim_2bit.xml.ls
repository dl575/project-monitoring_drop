...
<component id="root" name="root">
  <component id="system" name="system">
    ...
    <param name="target_core_clockrate" value="{1e-6/config.system.cpu0.clock*1e12}"/><!--MHz -->
    ...
    <stat name="runtime_sec" value="{stats.system.cpu0.numCycles * config.system.cpu0.clock / 1e12}"/>
    <stat name="total_cycles" value="{stats.system.cpu0.numCycles}"/>
    <stat name="idle_cycles" value="{stats.system.cpu0.num_idle_cycles}"/>
    <stat name="busy_cycles"  value="{stats.system.cpu0.numCycles - stats.system.cpu0.num_idle_cycles}"/>
    ...
    <component id="system.core0" name="core0">
      ...
      <stat name="total_instructions" value="{stats.system.cpu0.committedInsts}"/>
      <stat name="int_instructions" value="{stats.system.cpu0.num_int_insts}"/>
      <stat name="fp_instructions" value="{stats.system.cpu0.num_fp_insts}"/>
     ...
     <!-- ctorng: OOO <stat name="ROB_writes" value="stats.system.cpu0.rob.rob_writes"/>-->
      ...
      <!--  RF accesses -->
      <stat name="int_regfile_reads" value="{stats.system.cpu0.num_int_register_reads}"/>
      <stat name="float_regfile_reads" value="{stats.system.cpu0.num_fp_register_reads}"/>
      <stat name="int_regfile_writes" value="{stats.system.cpu0.num_int_register_writes}"/>
      <stat name="float_regfile_writes" value="{stats.system.cpu0.num_fp_register_writes}"/>
      ...
      <stat name="ialu_accesses" value="{stats.system.cpu0.num_int_alu_accesses}"/>			
      <stat name="fpu_accesses" value="{stats.system.cpu0.num_fp_alu_accesses}"/>
  ...
  -->
	...
	<stat name="total_accesses" value="{stats.system.cpu0.itb.accesses}"/>
	<stat name="total_hits" value="{stats.system.cpu0.itb.hits}"/>
	<stat name="total_misses" value="{stats.system.cpu0.itb.misses}"/>
  ...
  <stat name="read_accesses" value="{stats.system.cpu0.icache.ReadReq_accesses::total}"/>
	...
	<param name="number_entries" value="{config.system.cpu0.dtb.size}"/><!--dual threads-->
	<stat name="total_accesses" value="{stats.system.cpu0.dtb.accesses}"/>
	<stat name="total_hits" value="{stats.system.cpu0.dtb.hits}"/>
	<stat name="total_misses" value="{stats.system.cpu0.dtb.misses}"/>
	<stat name="conflicts" value="0"/><!-- TODO -->
      </component>
