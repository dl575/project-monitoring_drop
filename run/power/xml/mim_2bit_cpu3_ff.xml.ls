...
<component id="root" name="root">
  <component id="system" name="system">
    ...
    <param name="target_core_clockrate" value="{1e-6/config.system.switch_cpus3.clock*1e12}"/><!--MHz -->
    ...
    <stat name="runtime_sec" value="{stats.system.switch_cpus3.numCycles * config.system.switch_cpus3.clock / 1e12}"/>
    <stat name="total_cycles" value="{stats.system.switch_cpus3.numCycles}"/>
    <stat name="idle_cycles" value="{stats.system.switch_cpus3.num_idle_cycles}"/>
    <stat name="busy_cycles"  value="{stats.system.switch_cpus3.numCycles - stats.system.switch_cpus3.num_idle_cycles}"/>
    ...
    <component id="system.core0" name="core0">
      <!-- Core property -->
      <param name="clock_rate" value="{1e-6/config.system.switch_cpus3.clock*1e12}"/>
      ...
      <!-- ctorng: OOO <param name="instruction_window_size" value="config.system.cpu3.numIQEntries"/>-->
      <!-- ctorng: OOO <param name="fp_instruction_window_size" value="config.system.cpu3.numIQEntries"/>-->
      <!-- the instruction issue Q as in Alpha 21264; The RS as in Intel P6 -->
      <!-- ctorng: OOO <param name="ROB_size" value="config.system.cpu3.numROBEntries"/>-->
      ...
      <!-- ctorng: OOO <param name="phy_Regs_IRF_size" value="config.system.cpu3.numPhysIntRegs"/>-->
      <!-- ctorng: OOO <param name="phy_Regs_FRF_size" value="config.system.cpu3.numPhysFloatRegs"/>-->
      <!-- rename logic -->
      ...
      <!-- ctorng: OOO <param name="store_buffer_size" value="config.system.cpu3.SQEntries"/>-->
      <!-- By default, in-order cores do not have load buffers -->
      <!-- ctorng: OOO <param name="load_buffer_size" value="config.system.cpu3.LQEntries"/>	-->
      ...
      <param name="RAS_size" value="config.system.cpu3.branchPred.RASSize"/>						
      -->
      ...
      <stat name="total_instructions" value="{stats.system.switch_cpus3.committedInsts}"/>
      <stat name="int_instructions" value="{stats.system.switch_cpus3.num_int_insts}"/>
      <stat name="fp_instructions" value="{stats.system.switch_cpus3.num_fp_insts}"/>

      <!-- dlo: no branch predictor
      <stat name="branch_instructions" value="stats.system.cpu3.branchPred.condPredicted"/>
      <stat name="branch_mispredictions" value="stats.system.cpu3.branchPred.condIncorrect"/>
      <stat name="load_instructions" value="stats.system.cpu3.num_load_insts"/>
      <stat name="store_instructions" value="stats.system.cpu3.num_store_insts"/>
      <stat name="committed_instructions" value="stats.system.cpu3.committedInsts"/>
      <stat name="committed_int_instructions" value="stats.system.cpu3.num_int_insts"/>
      <stat name="committed_fp_instructions" value="stats.system.cpu3.num_fp_insts"/>
      -->
     ...
     <!-- ctorng: OOO <stat name="ROB_reads" value="stats.system.cpu3.rob.rob_reads"/>-->
     <!-- ctorng: OOO <stat name="ROB_writes" value="stats.system.cpu3.rob.rob_writes"/>-->
      <!-- RAT accesses -->
      <!-- ctorng: OOO <stat name="rename_reads" value="stats.system.cpu3.rename.int_rename_lookups"/> <!-lookup in renaming logic ->-->
      <!-- ctorng: OOO <stat name="rename_writes" value="int(stats.system.cpu3.rename.RenamedOperands * stats.system.cpu3.rename.int_rename_lookups / stats.system.cpu3.rename.RenameLookups)"/><!-update dest regs. renaming logic ->-->
      <!-- ctorng: OOO <stat name="fp_rename_reads" value="stats.system.cpu3.rename.fp_rename_lookups"/>-->
      <!-- ctorng: OOO <stat name="fp_rename_writes" value="int(stats.system.cpu3.rename.RenamedOperands * stats.system.cpu3.rename.fp_rename_lookups / stats.system.cpu3.rename.RenameLookups)"/>-->
      <!-- decode and rename stage use this, should be total ic - nop -->
      <!-- Inst window stats -->
      <!-- ctorng: OOO <stat name="inst_window_reads" value="stats.system.cpu3.iq.int_inst_queue_reads"/>-->
      <!-- ctorng: OOO <stat name="inst_window_writes" value="stats.system.cpu3.iq.int_inst_queue_writes"/>-->
      <!-- ctorng: OOO <stat name="inst_window_wakeup_accesses" value="stats.system.cpu3.iq.int_inst_queue_wakeup_accesses"/>-->
      <!-- ctorng: OOO <stat name="fp_inst_window_reads" value="stats.system.cpu3.iq.fp_inst_queue_reads"/>-->
      <!-- ctorng: OOO <stat name="fp_inst_window_writes" value="stats.system.cpu3.iq.fp_inst_queue_writes"/>-->
      <!-- ctorng: OOO <stat name="fp_inst_window_wakeup_accesses" value="stats.system.cpu3.iq.fp_inst_queue_wakeup_accesses"/>-->
      <!--  RF accesses -->
      <stat name="int_regfile_reads" value="{stats.system.switch_cpus3.num_int_register_reads}"/>
      <stat name="float_regfile_reads" value="{stats.system.switch_cpus3.num_fp_register_reads}"/>
      <stat name="int_regfile_writes" value="{stats.system.switch_cpus3.num_int_register_writes}"/>
      <stat name="float_regfile_writes" value="{stats.system.switch_cpus3.num_fp_register_writes}"/>
      <!-- accesses to the working reg -->
      <!-- ctorng: OOO <stat name="function_calls" value="stats.system.cpu3.commit.function_calls"/>-->
      <stat name="context_switches" value="{stats.system.cpu3.workload.num_syscalls}"/>
      <!-- Number of Windowes switches (number of function calls and returns)-->
      <!-- Alu stats by default, the processor has one FPU that includes the divider and 
	   multiplier. The fpu accesses should include accesses to multiplier and divider  -->
      <stat name="ialu_accesses" value="{stats.system.switch_cpus3.num_int_alu_accesses}"/>			
      <stat name="fpu_accesses" value="{stats.system.switch_cpus3.num_fp_alu_accesses}"/>
      <!--<stat name="mul_accesses" value="stats.system.cpu3.mult_div_unit.multiplies"/>-->
  ...
  <param name="local_predictor_size" value="config.system.cpu3.branchPred.localPredictorSize"/> <!-- ctorng rawr: NOT_SURE_IF_THIS_IS_RIGHT -->
  <!--
  <param name="local_predictor_entries" value="config.system.cpu3.branchPred.localHistoryTableSize"/>
	<param name="global_predictor_entries" value="config.system.cpu3.branchPred.globalPredictorSize"/>
	<param name="global_predictor_bits" value="config.system.cpu3.branchPred.globalCtrBits"/>
  <param name="chooser_predictor_entries" value="config.system.cpu3.branchPred.choicePredictorSize"/>
  <param name="chooser_predictor_bits" value="config.system.cpu3.branchPred.choiceCtrBits"/>
  -->
	...
	<!-- These parameters can be combined like below in next version
      ...
      <component id="system.core0.itlb" name="itlb">
        <param name="number_entries" value="{config.system.switch_cpus3.itb.size}"/>
	<stat name="total_accesses" value="{stats.system.switch_cpus3.itb.accesses}"/>
	<stat name="total_hits" value="{stats.system.switch_cpus3.itb.hits}"/>
	<stat name="total_misses" value="{stats.system.switch_cpus3.itb.misses}"/>
	...
	<!-- there is no write requests to itlb although writes happen to it after miss, 
	     which is actually a replacement -->
	<param name="icache_config" value="{join(',',config.system.cpu3.icache.size,config.system.cpu3.icache.block_size,config.system.cpu3.icache.assoc,1,1,config.system.cpu3.icache.hit_latency,32,0)}"/>
	<!-- the parameters are capacity,block_width, associativity, bank, throughput w.r.t. core clock, latency w.r.t. core clock,output_width, cache policy,  -->
  <!-- ctorng: the "output_width" is not used anywhere in mcpat -->
	<!-- cache_policy;//0 no write or write-though with non-write allocate;1 write-back with write-allocate -->
	<param name="buffer_sizes" value="{join(',',config.system.cpu3.icache.mshrs,config.system.cpu3.icache.mshrs,config.system.cpu3.icache.mshrs,config.system.cpu3.icache.mshrs)}"/> <!-- ctorng rawr: NOT_SURE_IF_THIS_IS_RIGHT -->
	<!-- cache controller buffer sizes: miss_buffer_size(MSHR),fill_buffer_size,prefetch_buffer_size,wb_buffer_size--> 
  <stat name="read_accesses" value="{stats.system.cpu3.icache.ReadReq_accesses::total}"/>
	<stat name="read_hits" value="{stats.system.cpu3.icache.ReadReq_hits::total}"/>
	<stat name="read_misses" value="{stats.system.cpu3.icache.ReadReq_misses::total}"/>
	<stat name="conflicts" value="{stats.system.cpu3.icache.replacements}"/>				
      </component>
      <component id="system.core0.dtlb" name="dtlb">
	<param name="number_entries" value="{config.system.switch_cpus3.dtb.size}"/><!--dual threads-->
	<stat name="total_accesses" value="{stats.system.switch_cpus3.dtb.accesses}"/>
	<stat name="total_hits" value="{stats.system.switch_cpus3.dtb.hits}"/>
	<stat name="total_misses" value="{stats.system.switch_cpus3.dtb.misses}"/>
	<stat name="conflicts" value="0"/><!-- TODO -->
      </component>
      <component id="system.core0.dcache" name="dcache">
	<!-- all the buffer related are optional -->
  <param name="dcache_config" value="{join(',',config.system.cpu3.dcache.size,config.system.cpu3.dcache.block_size,config.system.cpu3.dcache.assoc,1,1,config.system.cpu3.dcache.hit_latency,32,1)}"/>
	<param name="buffer_sizes" value="{join(',',config.system.cpu3.dcache.mshrs,config.system.cpu3.dcache.mshrs,config.system.cpu3.dcache.mshrs,config.system.cpu3.dcache.mshrs)}"/> <!-- ctorng rawr: NOT_SURE_IF_THIS_IS_RIGHT -->
	<!-- cache controller buffer sizes: miss_buffer_size(MSHR),fill_buffer_size,prefetch_buffer_size,wb_buffer_size-->	
	<stat name="read_accesses" value="{stats.system.cpu3.dcache.ReadReq_accesses::total}"/>
	<stat name="write_accesses" value="{stats.system.cpu3.dcache.WriteReq_accesses::total}"/>
	<stat name="read_hits" value="{stats.system.cpu3.dcache.ReadReq_hits::total}"/>
	<stat name="write_hits" value="{stats.system.cpu3.dcache.WriteReq_hits::total}"/>
	<stat name="read_misses" value="{stats.system.cpu3.dcache.ReadReq_misses::total}"/>
	<stat name="write_misses" value="{stats.system.cpu3.dcache.WriteReq_misses::total}"/>
  ...
  <param name="mcache_config" value="{join(',',config.system.cpu5.dcache.size,config.system.cpu5.dcache.block_size,config.system.cpu5.dcache.assoc,1,1,config.system.cpu5.dcache.hit_latency,32,1)}"/>
        ...
        <!-- LoadStoreU -->
        <stat name="LSU_duty_cycle" value="{stats.system.cpu5.dcache.overall_accesses::total/stats.system.switch_cpus3.numCycles}"/>
        ...
        <!-- ConfigTable -->
        <stat name="CT_duty_cycle" value="{stats.system.switch_cpus5.drops::total / stats.system.switch_cpus3.numCycles}"/>	
        <stat name="CT_reads" value="{stats.system.switch_cpus5.drops::total}"/>	
        <!-- FunctionalUnit -->
        <stat name="ALU_duty_cycle" value="{(stats.system.switch_cpus5.drops::total + stats.system.switch_cpus5.filtered::LOAD + stats.system.switch_cpus5.filtered::STORE + stats.system.switch_cpus5.filtered::INTALU) / stats.system.switch_cpus3.numCycles}"/>	
        ...
        <!-- FunctionalUnit -->
        <stat name="ALU_duty_cycle" value="{(stats.system.switch_cpus5.filtered::total + stats.system.switch_cpus5.drop::total + stats.system.switch_cpus5.non_drops::total) / stats.system.switch_cpus3.numCycles}"/>	
        <stat name="alu_accesses" value="{stats.system.switch_cpus5.filtered::INTALU}"/>			
        <!-- ConfigTable -->
				<stat name="CT_duty_cycle" value="{(stats.system.switch_cpus5.filtered::total + stats.system.switch_cpus5.drop::total + stats.system.switch_cpus5.non_drops::total) / stats.system.switch_cpus3.numCycles}"/>	
        ...
        <!-- FilterLookupTable -->
        <stat name="FLT_duty_cycle" value="{stats.system.switch_cpus5.filtered::total / stats.system.switch_cpus3.numCycles}"/>	
  ...
  <!-- dlo: no branch predictor
  <stat name="read_accesses" value="stats.system.cpu3.branchPred.BTBLookups"/> <!--See IFU code for guideline -->
  <!--<stat name="write_accesses" value="stats.system.cpu3.branchPred.BTBLookups - stats.system.cpu3.branchPred.BTBHits"/> <!-- ctorng rawr: NOT_SURE_IF_THIS_IS_RIGHT -->
      </component>
    </component>
    ...
    <component id="system.mem" name="mem">
      ...
      <stat name="memory_accesses" value="{stats.system.cpu3.icache.overall_misses::total + stats.system.cpu3.dcache.overall_misses::total}"/>
      <stat name="memory_reads" value="{stats.system.cpu3.icache.ReadReq_misses::total + stats.system.cpu3.dcache.ReadReq_misses::total}"/>
      <stat name="memory_writes" value="{stats.system.cpu3.icache.WriteReq_misses::total + stats.system.cpu3.dcache.WriteReq_misses::total}"/>
    </component>
