...
<component id="root" name="root">
  <component id="system" name="system">
    ...
    <param name="target_core_clockrate" value="{1e-6/config.system.cpu3.clock*1e12}"/><!--MHz -->
    ...
    <stat name="runtime_sec" value="{stats.system.cpu3.numCycles * config.system.cpu3.clock / 1e12}"/>
    <stat name="total_cycles" value="{stats.system.cpu3.numCycles}"/>
    <stat name="idle_cycles" value="{stats.system.cpu3.num_idle_cycles}"/>
    <stat name="busy_cycles"  value="{stats.system.cpu3.numCycles - stats.system.cpu3.num_idle_cycles}"/>
    ...
    <component id="system.core0" name="core0">
      <!-- Core property -->
      <param name="clock_rate" value="{1e-6/config.system.cpu3.clock*1e12}"/>
      ...
      <stat name="total_instructions" value="{stats.system.cpu3.committedInsts}"/>
      <stat name="int_instructions" value="{stats.system.cpu3.num_int_insts}"/>
      <stat name="fp_instructions" value="{stats.system.cpu3.num_fp_insts}"/>
     ...
     <!-- ctorng: OOO <stat name="ROB_writes" value="stats.system.cpu3.rob.rob_writes"/>-->
      ...
      <!--  RF accesses -->
      <stat name="int_regfile_reads" value="{stats.system.cpu3.num_int_register_reads}"/>
      <stat name="float_regfile_reads" value="{stats.system.cpu3.num_fp_register_reads}"/>
      <stat name="int_regfile_writes" value="{stats.system.cpu3.num_int_register_writes}"/>
      <stat name="float_regfile_writes" value="{stats.system.cpu3.num_fp_register_writes}"/>
      ...
      <stat name="ialu_accesses" value="{stats.system.cpu3.num_int_alu_accesses}"/>			
      <stat name="fpu_accesses" value="{stats.system.cpu3.num_fp_alu_accesses}"/>
  ...
  -->
	...
	<!-- These parameters can be combined like below in next version
      ...
      <component id="system.core0.itlb" name="itlb">
        <param name="number_entries" value="{config.system.cpu3.itb.size}"/>
	<stat name="total_accesses" value="{stats.system.cpu3.itb.accesses}"/>
	<stat name="total_hits" value="{stats.system.cpu3.itb.hits}"/>
	<stat name="total_misses" value="{stats.system.cpu3.itb.misses}"/>
  ...
  <stat name="read_accesses" value="{stats.system.cpu3.icache.ReadReq_accesses::total}"/>
	...
	<param name="number_entries" value="{config.system.cpu3.dtb.size}"/><!--dual threads-->
	<stat name="total_accesses" value="{stats.system.cpu3.dtb.accesses}"/>
	<stat name="total_hits" value="{stats.system.cpu3.dtb.hits}"/>
	<stat name="total_misses" value="{stats.system.cpu3.dtb.misses}"/>
	<stat name="conflicts" value="0"/><!-- TODO -->
      </component>
  ...
  <param name="mcache_config" value="{join(',',config.system.cpu5.dcache.size,config.system.cpu5.dcache.block_size,config.system.cpu5.dcache.assoc,1,1,config.system.cpu5.dcache.hit_latency,32,1)}"/>
        ...
        <!-- LoadStoreU -->
        <stat name="LSU_duty_cycle" value="{stats.system.cpu5.dcache.overall_accesses::total/stats.system.cpu3.numCycles}"/>
        ...
        <!-- ConfigTable -->
        <stat name="CT_duty_cycle" value="{stats.system.cpu5.drops::total / stats.system.cpu3.numCycles}"/>	
        <stat name="CT_reads" value="{stats.system.cpu5.drops::total}"/>	
        <!-- FunctionalUnit -->
        <stat name="ALU_duty_cycle" value="{(stats.system.cpu5.drops::total + stats.system.cpu5.filtered::LOAD + stats.system.cpu5.filtered::STORE + stats.system.cpu5.filtered::INTALU) / stats.system.cpu3.numCycles}"/>	
        ...
        <!-- FunctionalUnit -->
        <stat name="ALU_duty_cycle" value="{(stats.system.cpu5.filtered::total + stats.system.cpu5.drop::total + stats.system.cpu5.non_drops::total) / stats.system.cpu3.numCycles}"/>	
        <stat name="alu_accesses" value="{stats.system.cpu5.filtered::INTALU}"/>			
        <!-- ConfigTable -->
				<stat name="CT_duty_cycle" value="{(stats.system.cpu5.filtered::total + stats.system.cpu5.drop::total + stats.system.cpu5.non_drops::total) / stats.system.cpu3.numCycles}"/>	
        ...
        <!-- FilterLookupTable -->
        <stat name="FLT_duty_cycle" value="{stats.system.cpu5.filtered::total / stats.system.cpu3.numCycles}"/>	
